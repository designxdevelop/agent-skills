...
For any flagged phrase, ask in order:

1. Does cutting it lose meaning? If yes, it may be content, not slop. Keep or reword to preserve the meaning.
2. Is it formula or choice? Would the author defend it, or did a pattern put it there?
3. Does it announce rather than deliver? Meta-commentary about the writing is almost always cuttable.
4. Does it add heat or light? Intensifiers and flourishes add heat. Cut heat, keep light.
5. Would a skeptical reader trust the sentence more or less without it? Optimize for trust.
